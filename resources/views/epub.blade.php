...
<body class="theme-light h-screen flex flex-col overflow-hidden">
    ...
    <main class="flex flex-1 overflow-hidden relative">
        <!-- Sidebar (Chapters) -->
        <aside id="sidebar"
            class="sidebar-transition absolute left-0 top-0 h-full w-64 bg-white dark:bg-gray-800 shadow-lg z-20 transform -translate-x-full">
            <div class="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <div id="reader-container" class="flex-1 flex overflow-auto page-transition">
            ...
            <!-- Dual Page View (hidden by default) -->
            <div id="dual-page" class="flex-1 hidden">
                <div class="flex h-full">
                    <div class="w-1/2 p-8 border-r border-gray-200 dark:border-gray-700">
                        <div class="prose dark:prose-invert max-w-none">
                            <div id="chapter-content">
                                @if ($initial_path)
                                    <!-- Content will be loaded here -->
    ...
    <!-- Footer Navigation -->
    <footer class="bg-white dark:bg-gray-800 shadow-sm z-10">
        <div class="container mx-auto px-4 py-3 flex justify-between items-center">
            <button id="prev-btn"
